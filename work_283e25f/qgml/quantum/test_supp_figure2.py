...
def test_generate_supplementary_figure2():
    ...
    n_epochs = 2000 # Increased epochs from previous run 
    learning_rate = 0.005
    ...
    estimator_n3 = DimensionEstimator(trainer_n3, device=device)
    ...
    estimator_n4 = DimensionEstimator(trainer_n4, device=device)
