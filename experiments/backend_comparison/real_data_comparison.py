"""
Real Test Comparison: JAX vs PyTorch on Actual qcml Test Cases

This script runs the actual test cases from qcml/tests/ and compares
...
print("PyTorch implementation not available")
...
# Import qcml components
try:
from qcml.manifolds import SphereManifold, CircleManifold
...
print(" qcml components imported successfully")
except ImportError:
print("️ qcml components not available")
...
"""Compare JAX vs PyTorch on actual qcml test cases."""

def __init__(self):
"""Initialize the real test comparison."""
# Test cases from actual qcml tests
self.test_cases = [
{
'name': 'test_fig1',
...
logger.info("=" * 70)
logger.info(" Running Actual qcml Test Cases:")
...
f.write("# Real Test Comparison: JAX vs PyTorch on qcml Test Cases\n\n")
...
print(" Real Test Comparison: JAX vs PyTorch on qcml Test Cases")
print("=" * 70)
